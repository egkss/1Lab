...
int weight()
{
	...
	while (true)
	{
		...
		if ((cin.fail()) || (m <= 0))
		{
			cin.clear();
			cin.ignore(10, '\n');
			cout << "Body weight is wrong, try again" << endl;
		}
		else
		{
			return m;
...
double angle()
{
	while (true)
	{
		...
		if ((cin.fail()) || a <= 0 || a >= 90)
		{
			cin.clear();
			cin.ignore(10, '\n');
			cout << "The angle is wrong, try again" << endl;
		}
		else
		{
			return a;
...
double force()
{
	while (true)
	{
		...
		if ((cin.fail()) || (f < 0))
		{
			cin.clear();
			cin.ignore(10, '\n');
			cout << "The force is wrong, try again" << endl;
		}
		else
		{
			return f;
...
double friction()
{
	while (true)
	{
		...
		if ((cin.fail()) || (u < 0))
		{
			cin.clear();
			cin.ignore(10, '\n');
			cout << "The coefficient is wrong, try again" << endl;
		}
		else
		{
			return u;
